      ...
      <div className="container mx-auto px-4">
        ...
        <div className="lg:grid lg:grid-cols-4 lg:gap-8">
          ...
          <div className="lg:col-span-1 mb-8 lg:mb-0">
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 sticky top-32">
              {/* Categories */}
              <div className="mb-8">
                  ...
                  {categories.map((category) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex-1 lg:flex-none flex items-center justify-center lg:justify-start gap-3 px-4 py-3 rounded-xl transition-all ${
              ...
              <div>
                ...
                <p className="text-sm text-gray-400 mt-2">Pods per pack</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-3">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredPods.map((pod) => (
                <div
                  key={pod.id}
                  className="group relative bg-white/5 backdrop-blur-lg rounded-2xl p-4 hover:bg-white/10 transition-all duration-300"
                ...
                >
                  <div className="relative aspect-square mb-4 rounded-xl overflow-hidden">
                    ...
                    <div className={`absolute inset-0 bg-black/50 flex items-center justify-center transition-opacity duration-300 ${
                      ...
                      <button className="bg-green-500 text-black px-6 py-3 rounded-full flex items-center gap-2 transform hover:scale-105 transition-transform">
